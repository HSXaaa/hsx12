...
public class IdentityController{
	...
	@RequestMapping("/send")	
	public String Identity(Model model,HttpServletRequest request, HttpServletResponse response) throws Exception {
	 ...
	 String result=post(req,"https://ssp.scnu.edu.cn/api/UserValidate.ashx");
     ...
     return "info";
      ...
      return "redirect:/index.jsp?error=error";
	 }
