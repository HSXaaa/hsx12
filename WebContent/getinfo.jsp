...
<div class="container">
  ...
  <div class="card">
   <div class="card-block">
      ...
      <h2 align="center">UserXm:${UserXm}</h2>
      <h2 align="center">UserUnit:${UserUnit}</h2>
      <h2 align="center">UserUnitName:${UserUnitName}</h2>
      <h2 align="center">IsSir:${IsSir}</h2>
      <h2 align="center">UserType:${UserType}</h2>
      <h2 align="center">UserTypeName:${UserTypeName}</h2>
   </div>
  </div> 
 </div>
</main>
